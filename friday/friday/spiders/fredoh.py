import scrapy
from ..items import FridayItem
from scrapy.loader import ItemLoader
from scrapy.spiders import CrawlSpider, Rule
from scrapy.linkextractors import LinkExtractor


class FredohSpider(CrawlSpider):
    name = 'fredoh'
    allowed_domains = ['www.arizonarealestate.com']
    start_urls = ['https://www.arizonarealestate.com']
    rules =(
        Rule(
    ...
    def parse(self, response):
        ...
        for listing in gallery:
            item = ItemLoader(item=FridayItem(), response=response, selector=listing)
